export default {
  ...
  customers: {
    ...
    customerNotEnoughMoneyDoConnectItQuestion:
      "Doesn't the subscriber have sufficient means to include the service, to minus it?",
    ...
    flags: "Abbreviations",
    docs: "General Assembly Documents",
    session: "Session",
    ...
    areUSure2DelIpLease:
      "Remove the hip? The subscriber will no longer be able to get a service through this hip.",
    ...
    passportSrialValidationMsg:
      "The passport series should not be more than four symbols.",
    passportNum: "Pass number.",
    passportNumRequiredMsg: "Give me the passport number.",
    passportNumValidatationMsg:
      "The passport number shall not be more than 6 symbols.",
    ...
    passportDateOfAcceptanceRequiredMsg:
      "You should indicate when it was issued.",
    password: "Password",
    ...
    usernameRequiredValidatorErrText:
      "The logic of the subscriber is obligatory.",
    ...
    customerDeletionConfigmation:
      "You sure you can remove the subscription? With her, the entire history of the Bling account will be removed.",
    accountRemovedOk: "Record removed",
    streets: "Streets",
    withoutAddrs: "No address",
    whoHaveRightsOnCustomer: "Who's entitled to a subscription?",
    marker: "Marker",
  ...
  contractDocs: {
    ...
    dateBegin: "Effective date",
    dateEnd: "Date of termination of contract",
    activity: "Activity",
    activeContract: "Existing treaty",
    additional: "Dep.",
    addedMsg: "Treaty",
    savedMsg: "Treaty protected",
    customerContract: "Treaty of subscriber",
