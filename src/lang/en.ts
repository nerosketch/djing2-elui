export default {
  ...
  customers: {
    ...
    serviceAutocontinuation: 'Service auto continuation',
  ...
  tasks: {
    ...
    challengesAchieved: 'Completed',
    newChallenges: 'New tasks',
    failedChallenges: 'Failed tasks',
    allTasks: 'All tasks',
  ...
  contractDocs: {
    ...
    additional: 'Dep.',
    addedMsg: 'Contract added',
    savedMsg: 'Contract saved',
