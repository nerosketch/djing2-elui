export default {
  ...
  hipLeases: "Аренды ip",
  "iMBeggingYou.": "Back to home",
  balance: "Баланс",
  baseAccountFunction: "Базовый расчётный функционал",
  brauser: "Браузер",
  boom: "Bums",
  burst: "Бурст",
  price: "Цена",
  ...
  soupport: "Customer Support",
  date: "Дата",
  effectiveDate: "Дата введения в эксплуатацию",
  dateOfEstablishment: "Дата создания",
  "itSTrueToRemoveTheGroup.": "Действительно удалить группу",
  birthday: "День рождения",
  targets: "Детали задачи",
  development: "Development",
  "deweedIsARiver.": "devId required.",
  dynamic: "Динамический",
  addTheName: "Добавить домен",
  addTheGroup: "Добавить группу",
  addMassenger: "Добавить Messenger",
  addIt: "Добавить ONU",
  addFields: "Добавить поля",
  addALock: "Добавить шлюз",
  ...
  "directorSFig.": "Фио директора обязательно",
  forms: "Формы",
  photo: "Фото",
  hotel: "Гостевой",
  openingSessions: "Гостевые сессии",
  ation: ">",
  panel: "Группа",
  groupAmended: "Группа изменена",
  groupRetained: "Группа сохранена",
  ualienGroup: "Группа уалена",
  ...
  modifyThePlausibleLock: "Изменить платёжный шлюз",
  ...
  "iNeedADescription.": "Какае-то описание нужно",
  ...
  "heSAContractor,HeSAContractFormAndHeSGotAContract.":
    "Logic error on contractForm in onSubmit()",
  login: "Логин",
  ...
  "mac.": "Мак",
  "macSAddressFromTheAltogether:": "Мак адрес с OLT:",
  'macSAddressInTheBillingDoesnTMatchTheAddressFromTheAddress.WeCouldUseTheButtonBelow"Remediate."IfSheDoesnTHelp,"HeSNotFoundOnTheAltogether"MeansThereSNoConnectionBetweenHimAndTheAltogether,AndThereSNoConfigurationOfThisGuyOnTheAltoeEither.YouCanAlsoCheckThePlaceOnTheVerb,MaybeItSFilled.':
    'Мак адрес в билинге не совпадает с мак адресом, полученным с OLT. Можно попробовать воспользоваться кнопкой ниже "Исправить". Если и она не помогает, "ONU не найдена на OLT" то это значит что нет связи между ONU и OLT, и конфигурации этой ONU на OLT тоже нет. Так же можно проверить место на "глазе" olt, может он заполнен.',
  "32SymbolsForServants": "Максимум 32 символа для slug",
  makers: "Markers",
  marketing: "Marketing",
  ...
  "iDidnTFindTheRightToRead.": "Не нашёл права на чтение",
  notSpecified: "не определено",
  notDefined: "Не определён",
  notTransferred: "Не передан ID задачи",
  "doesnTSoundLikeAnE-MailAddress.": "Не похоже на адрес почты",
  "notRemoved,ItLooksLikeSomeoneSAlreadyRemoved.":
    "Не удалили, похоже уже кто-то удалил",
  notAvailable: "Не удалось получить группы",
  notSelected: "Не выбрано",
  insufficientRights: "Недостаточно прав",
  "noInformationOnHim.(DopInfoForSnmpInTheFormOfAEditingDevice).ProbablyNotRegistered.":
  ...
  unregisteredYouth: "Незарегистрированные юниты",
  low: "Низкий",
  theContractNumberMayContainLatinSymbolsAndFigures:
    "Номер договора может содержать латинские символы и цифры",
  houseNumber: "Номер дома(уст.)",
  telephoneNumber: "Номер телефона",
  "thePhoneNumberIsMandatory.": "Номер телефона обязательно",
  new: "Новая",
  newGroupAdded: "Новая группа добавлена",
  "theNewOneIsRetained.": "Новая onu сохранена",
  ...
  "needsLoginFromLatinSymbolsAndFigures.":
    "Нужен логин из латинских символов и цифр",
  ...
  "weNeedToSelectTheRightTypeOfJuriqueFromTheListOfValues.":
    "Нужно выбрать из списка значений подходящий тип юрлица",
  ...
  "youNeedToKnowTheNameOfTheOwnerOfTheAccount.":
    "Нужно знать как зовут владельца учётки",
  "iNeedToKnowWhatApiWillBeWorkingWith.":
    "Нужно знать с каким API будет работать бот",
  ...
  thePasswordConsistsOfAMinimumOf6Symbols:
    "Пароль состоит минимум из 6ти символов",
  ...
  thePostalIndexContainsNotMoreThan6Symbols:
    "Почтовый индекс содержит не более 6ти символов",
  ...
  "portCanTContainMoreThanOneAcques.":
    "Порт не может содержать больше одного access vlan",
  ...
  "example:192.168.0.23": "Пример ip: 192.168.0.23",
  "example:0A:0B:Cc:Dd:Ee:Ff": "Пример mac: 0a:0b:cc:dd::ee:ff",
  "example:192.168.0.024": "Пример подсети: 192.168.0.0/24",
  "exampleOfLock:192.168.0.1": "Пример шлюза: 192.168.0.1",
  ...
  theContentOfThePayloadableSiteIsMaintained:
    "Принадлежность платёжного шлюза сайтам сохранена",
  ...
  loss: "Провалена",
  challenges: "Проваленные задачи",
  the: "путь",
  distributionOfServicesBySubscribers:
    "Распределение использования услуг абонентами",
  editorial: "Редактировать",
  regime: "Режим",
  "theDevice.": "Родит. устройство",
  "parentalOyster:": "Родительское устр.:",
  "parentalDevice:": "Родительское устройство:",
  ...
  "heSGotAScalpForTheMan.": "Шаблон конфига для ONU",
  surface: "Шлюз",
  ...
  "copyTheAddressFromTheLegalAddress.":
    "Скопировать адрес из юридического адреса",
  ...
  "removeTheBandOfSubscribers?": "Удалить группу абонентов?",
  "removeTheConstructionFromThePort?": "Удалить настройки с порта?",
  "removeThePayLock?": "Удалить платёжный шлюз?",
  deleteTheField: "Удалить поле",
  "removeTheAltogether.": "Удалить с OLT",
  "removeTheAccessLockForTheSubscribers?": "Удалить шлюз доступа абонентов?",
  "removeTheRecord?": "Удалить учётную запись?",
  ...
  "theTaskWillBeRemovedNow,Carefully.":
    "Задача сейчас будет удалена, внимательно",
  ...
  "closed.": "Закрыт",
  complete: "Завершить",
  "finishTheSession?": "Завершить сессию?",
  "iron.": "Железка",
