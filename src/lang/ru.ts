export default {
  ...
  "7-8-9-3-i-10-11-cifr": "+[7,8,9,3] и 10,11 цифр",
  "7-8-9-3-i-10-11-cifr-0": "+[7,8,9,3] и 10,11 цифр",
  "7-8-9-3-i-10-11-cifr-1": "+[7,8,9,3] и 10,11 цифр",
  "a-less-than-br-greater-than-b-c-d": "{a} <br/>{b} : {c} ({d}%)",
  "abonent": "Абонент",
  "abonent-0": "Абонент:",
  ...
  "actual-spending-0": "Actual Spending",
  "admin": "Админ.",
  ...
  "allocated-budget-0": "Allocated Budget",
  "and-nbsp-ab-full_name": " {0}",
  "and-nbsp-device-parent_dev_name": " {0}",
  "and-nbsp-row-is_management-da-net": " {0}",
  "and-nbsp-store-state-customerlegal-balance": " {0}.",
  "and-nbsp-store-state-customerlegal-create_date": " {0}",
  "arendy-ip": "Аренды ip",
  "avtor-zadachi-store-state-task-author_full_name": "Автор задачи: {0}",
  ...
  "bums": "Bums",
  "burst": "Бурст",
  "c-fio-c-group_title": "{0}, {1}.",
  "cena": "Цена",
  "cena-dolzhna-byt-polozhitelnoi-ili-0": "Цена должна быть положительной или 0",
  "cena-dolzhna-byt-polozhitelnoi-ili-0-0": "Цена должна быть положительной или 0",
  "cena-dolzhna-byt-polozhitelnoi-ili-0-1": "Цена должна быть положительной или 0",
  "cena-dolzhna-byt-ukazana": "Цена должна быть указана",
  "cenu-nado-ukazat": "Цену надо указать",
  "cenu-nado-ukazat-0": "Цену надо указать",
  "chastota-ispolzovaniya-kharakterov-zadach": "Частота использования характеров задач",
  "chat-bot-izmenyon": "Чат бот изменён",
  "chat-bot-m-title-udalyon": "Чат бот \"{0}\" удалён",
  "chat-bot-sozdan": "Чат бот создан",
  "chto-to-zavershyonnoe": "Что-то завершённое",
  "comments": "Comments",
  "customer-support": "Customer Support",
  "customers-birthday": "{0}",
  "customers-passportdistributor": "{0}",
  "customers-passportdivisioncode": "{0}",
  "customers-passportdivisioncode-0": "{0}",
  "customers-poolsnotexists": "{0}",
  "d": "Д",
  "data": "Дата",
  "data-0": "Дата",
  "data-1": "Дата",
  ...
  "data-sozdaniya-0": "Дата создания",
  "data-sozdaniya-1": "Дата создания:",
  "data-sozdaniya-2": "Дата создания",
  "data-vvedeniya-v-ekspluataciyu": "Дата введения в эксплуатацию",
  "data-vvedeniya-v-ekspluataciyu-0": "Дата введения в эксплуатацию",
  "data-vvedeniya-v-ekspluataciyu-1": "Дата введения в эксплуатацию",
  ...
  "dobavit-ustroistvo-0": "Добавить устройство",
  ...
  "dop-info-dlya-snmp-0": "Доп. инфо для snmp",
  ...
  "expected-spending-0": "Expected Spending",
  "fiber-fb_name-fiber-fb_active_onu-fiber-fb_onu_num": "{0} ({1}/{2})",
  ...
  "imya-1": "Имя",
  "imya-2": "Имя",
  "imya-data-name-v-seti-data-uptime-versiya-proshivki-data-fver": "Имя {0}. В сети {1}. Версия прошивки {2}.",
  ...
  "ispolniteli-0": "Исполнители:",
  "isprav-oshibki-formy": "Исправь ошибки формы",
  "ispravit": "Исправить",
  "ispravit-0": "Исправить",
  "izmenenie": "Изменение",
  ...
  "kharakter-polomki-0": "Характер поломки:",
  "kharakter-polomki-1": "Характер поломки",
  ...
  "kolich-platezhei-0": "Колич. платежей",
  ...
  "login-dlya-vkhoda-0": "Логин для входа",
  ...
  "login-ne-mozhet-byt-pustym-0": "Логин не может быть пустым",
  "login-ne-mozhet-byt-pustym-1": "Логин не может быть пустым",
  "loid-parol": "LOID пароль",
  "mac-adres": "MAC Адрес",
  "mac-adres-0": "MAC Адрес",
  "mac-adres-1": "MAC Адрес",
  "mac-adres-2": "MAC Адрес",
  "mac-ne-mozhet-byt-pustym": "MAC не может быть пустым",
  "mac-ne-mozhet-byt-pustym-0": "MAC не может быть пустым",
  ...
  "messendzhery-0": "Мессенджеры",
  "messendzhery-1": "Мессенджеры",
  "mikrotik": "Микротик",
  "nach-ip": "Нач. ip",
  "nach-ip-0": "нач. ip",
  ...
  "nazvanie-gruppy-nado-ukazat-0": "Название группы надо указать",
  "nazvanie-nado-ukazat": "Название надо указать",
  "nazvanie-nado-ukazat-0": "Название надо указать",
  "nazvanie-nado-ukazat-1": "Название надо указать",
  "nazvanie-nado-ukazat-2": "Название надо указать",
  "nazvanie-nuzhno-ukazat": "Название нужно указать",
  "nazvanie-platezha": "Название платежа",
  "nazvanie-platezha-0": "Название платежа",
  ...
  "nedostatochno-prav-0": "Недостаточно прав",
  "nedostatochno-prav-1": "Недостаточно прав",
  ...
  "novaya-onu-sokhranena-0": "Новая onu сохранена",
  ...
  "oborudovanie-0": "Оборудование",
  "oborudovanie-1": "Оборудование",
  ...
  "opisanie-0": "Описание",
  "opisanie-1": "Описание",
  "opisanie-10": "Описание",
  "opisanie-11": "Описание",
  "opisanie-12": "Описание",
  "opisanie-13": "Описание",
  "opisanie-2": "Описание:",
  "opisanie-3": "Описание",
  "opisanie-4": "Описание",
  "opisanie-5": "Описание",
  ...
  "opoveshat-pri-sobytiyakh-monitoringa-0": "Оповещать при событиях мониторинга",
  ...
  "otchyoty-vsyakie-0": "Отчёты всякие",
  "otmena": "Отмена",
  "otmena-0": "Отмена",
  ...
  "parol-dlya-vkhoda-0": "Пароль для входа",
  "parol-ne-mozhet-byt-pustym": "Пароль не может быть пустым",
  "parol-ne-mozhet-byt-pustym-0": "Пароль не может быть пустым",
  "parol-sostoit-minimum-iz-6ti-simvolov": "Пароль состоит минимум из 6ти символов",
  "parol-sostoit-minimum-iz-6ti-simvolov-0": "Пароль состоит минимум из 6ти символов",
  "parol-sostoit-minimum-iz-6ti-simvolov-1": "Пароль состоит минимум из 6ти символов",
  "parol-sostoit-minimum-iz-6ti-simvolov-2": "Пароль состоит минимум из 6ти символов",
  ...
  "platyozhnyi-shlyuz-0": "Платёжный шлюз",
  ...
  "podseti": "Подсети",
  "poisk-po-searchtextgetter": "Поиск по: {0}",
  "pole": "Поле",
  ...
  "primer-ip-192-168-0-23-0": "Пример ip: 192.168.0.23",
  "primer-ip-192-168-0-23-1": "Пример ip: 192.168.0.23",
  "primer-ip-192-168-0-23-2": "Пример ip: 192.168.0.23",
  "primer-ip-192-168-0-23-3": "Пример ip: 192.168.0.23",
  "primer-mac-0a-0b-cc-dd-ee-ff": "Пример mac: 0a:0b:cc:dd::ee:ff",
  "primer-mac-0a-0b-cc-dd-ee-ff-0": "Пример mac: 0a:0b:cc:dd::ee:ff",
  "primer-mac-0a-0b-cc-dd-ee-ff-1": "Пример mac: 0a:0b:cc:dd::ee:ff",
  "primer-podseti-192-168-0-0-24": "Пример подсети: 192.168.0.0/24",
  "primer-shlyuza-192-168-0-1": "Пример шлюза: 192.168.0.1",
  ...
  "prinadlezhnost-saitam-0": "Принадлежность сайтам",
  "prinadlezhnost-saitam-1": "Принадлежность сайтам",
  "prinadlezhnost-saitam-2": "Принадлежность сайтам",
  "prinadlezhnost-saitam-3": "Принадлежность сайтам",
  "prinadlezhnost-saitam-4": "Принадлежность сайтам",
  "prinadlezhnost-saitam-5": "Принадлежность сайтам",
  "prinadlezhnost-saitam-6": "Принадлежность сайтам",
  ...
  "prinadlezhnost-uslugi-saitam-sokhranena-0": "Принадлежность услуги сайтам сохранена",
  ...
  "rodit-ustroistvo-0": "Родит. устройство",
  ...
  "service-id-obyazatelno-0": "Service ID обязательно",
  "services": "Services",
  ...
  "sistemnyi-teg-0": "Системный тэг",
  "skachat-csv": "Скачать csv",
  "skopirovat-adres-iz-yuridicheskogo-adresa": "Скопировать адрес из юридического адреса",
  "skopirovat-adres-iz-yuridicheskogo-adresa-0": "Скопировать адрес из юридического адреса",
  ...
  "snmp-community-0": "SNMP Community",
  "snmp-nom": "SNMP Ном.",
  "sokhranit": "Сохранить",
  "sokhranit-onu": "Сохранить ONU",
  "sostoyanie": "Состояние",
  "sostoyanie-0": "Состояние",
  "sostoyanie-1": "Состояние:",
  "sostoyanie-2": "Состояние",
  ...
  "startovyi-ip-nado-ukazat-0": "Стартовый ip надо указать",
  "staryi-parol": "Старый пароль",
  "stoimost": "Стоимость",
  "stoimost-0": "стоимость",
  "stoimost-1": "Стоимость",
  "stoimost-2": "Стоимость",
  "stoimost-3": "Стоимость",
  "store-state-customer-balance": "{0}.",
  "summa": "Сумма",
  "summa-0": "Сумма",
  "superpolzovatel": "Суперпользователь",
  "superpolzovatel-0": "Суперпользователь",
  "sutochnaya": "Суточная",
  "t-adresnyi-obekt": "{0} адресный объект",
  "t-attention": "{0}!",
  "t-contractdocs-activecontract-frmmod-is_active-t-yes-t-sno": "- {0}: {1}",
  "t-createdate": "{0}:",
  "t-customers-afkoutlimit": "{0}:",
  "t-customers-afkreferencedate": "{0}:",
  "t-customers-balance": "{0}:",
  "t-customers-balance-0": "{0}:",
  "t-customers-dhcpdynamic": "- {0}:",
  "t-customers-isactive": "- {0}:",
  "t-customers-serviceautocontinuation": "{0} -",
  "t-customers-servicelastconnected": "{0} -",
  "t-domen": "{0} домен",
  "t-startdate": "{0}:",
  ...
  "tegi-dolzhny-soderzhat-tolko-bukvy-cifry-i-znak-podchyorkivaniya": "Тэги должны содержать только буквы, цифры и знак подчёркивания (как [a-zA-Z0-9_]). И могут быть разделены запятой.",
  ...
  "tip-oborudovaniya-0": "Тип оборудования",
  "tip-polya": "Тип поля",
  "tip-polya-0": "Тип поля",
  "tip-seti": "Тип сети",
  ...
  "ukazhi-ustroistvu-kakoe-to-imya-0": "Укажи устройству какое-то имя",
  "ukazhi-vkhodyashuyu-skorost": "Укажи входящую скорость",
  "upravl": "Управл.",
  "upravlenie": "Управление",
  "upravlenie-0": "Управление",
  ...
  "uspeshno-sokhraneno-0": "Успешно сохранено",
  ...
  "vydelit-prava-na-chtenie-0": "Выделить права на чтение",
  "vyklyuchit-port-otklyuchitsya-link-vnimatelno-ne-vyklyuchi-uplin": "Выключить порт? Отключится линк. Внимательно, не выключи uplink, иначе коммутатор потеряется",
  "vypolnena": "Выполнена",
