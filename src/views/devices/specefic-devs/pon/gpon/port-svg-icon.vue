  ...
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 14.032 14.032" style="enable-background:new 0 0 14.032 14.032;" xml:space="preserve">
    <g>
      <g>
        ...
        <path :style="frmInColor" d="M10.476,4.236H9.402V2.7c0-0.222-0.204-0.402-0.457-0.402h-3.95c-0.252,0-0.457,0.18-0.457,0.402 v1.536H3.555c-0.442,0-0.801,0.315-0.801,0.705v6.089c0,0.39,0.358,0.705,0.801,0.705h1.346v-3.98h0.686v3.98h1.086v-3.98h0.686 v3.98h1.029v-3.98h0.686v3.98h1.402c0.442,0,0.801-0.315,0.801-0.705V4.941C11.277,4.551,10.918,4.236,10.476,4.236z"></path>
      </g>
    </g>
  </svg>
</template>
