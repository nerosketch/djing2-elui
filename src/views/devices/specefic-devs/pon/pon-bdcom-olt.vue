<template>  
  <el-card>
    ...
    <el-row v-if="ready">
      <el-col :span="24" v-for="(fiber, i) in fibers" :key="i">
        <el-card shadow="never">
          <template v-slot:header>
            <div class="clearfix">{{ fiber.fb_name }} ({{ fiber.fb_active_onu }}/{{ fiber.fb_onu_num }})</div>
          </template>
          <el-table :data="fiber.onuList" border fit>
