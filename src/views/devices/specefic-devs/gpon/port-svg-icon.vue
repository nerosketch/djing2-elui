...
<g>
	<g>
		<path :style="frmOutlineColor" d="M12.797,0H1.234C0.553,0,0.001,0.554,0.001,1.234v11.564c0,0.681,0.554,1.234,1.234,1.234h11.563
		...
		<path :style="frmInColor" d="M10.476,4.236H9.402V2.7c0-0.222-0.204-0.402-0.457-0.402h-3.95c-0.252,0-0.457,0.18-0.457,0.402
...
export default class extends Vue {
  @Prop({ default: '030104' }) private outlineColor!: string
  @Prop({ default: '030104' }) private inColor!: string

  get frmOutlineColor() {
    return `fill:#${this.outlineColor};`
  }

  get frmInColor() {
    return `fill:#${this.inColor};`
  }
}
</script>
