          ...
          template(v-if="customers.length > 0")
            el-card(
              ...
              div
                ...
                router-link.el-link.el-link--primary.is-underline(:to="{ name: 'customerDetails', params: {uid: c.id } }")
                  | {{ c.username }}
            
              span
                | {{ $t('c-fio-c-group_title', [c.fio, c.group_title]) }}
              ...
              template(v-if="devices.length > 0")
                el-card(
                  ...
                  div
                    ...
                    router-link.el-link.el-link--primary.is-underline(:to="{name: 'device-view', params: { devId: d.id.toString()}}")
